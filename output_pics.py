...
if __name__ == '__main__':
    ...
    density_model_path = '/models/trained_models/density/20190419150454/srcnn2d_epoch_70.pth'
    pressure_model_path = '/models/trained_models/pressure/20190403101521/srcnn2d_epoch_150.pth'
    velocity_model_path = '/models/trained_models/velocity/20190403182351/srcnn2d_epoch_150.pth'

    density_modified_model_path = '/models/trained_models/density/20190419191825/modified_srcnn2d_epoch_70.pth'
